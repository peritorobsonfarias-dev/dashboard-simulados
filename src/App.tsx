...
const QUESTION_BANK: Question[] = [
  ...
  }
  {
    ...
    banca: "FCC",
    difficulty: "Média",
    statement: "Considere o seguinte trecho: 'A Secretaria da Fazenda de Santa Catarina estabeleceu três metas prioritárias para o exercício fiscal: modernizar os sistemas de fiscalização tributária; capacitar continuamente o corpo técnico de auditores; e garantir a transparência das contas públicas perante a sociedade.' A respeito da pontuação empregada, assinale a opção correta.",
    options: [
  ...
  }
  {
    ...
    banca: "FCC",
    difficulty: "Média",
    statement: "Assinale a opção que preenche correta e respectivamente as lacunas da frase: 'O contribuinte solicitou a ______ do imposto devido, alegando que a alíquota aplicada iria ______ os seus investimentos no Estado.'",
    options: [
      "A) remissão - afetar",
      "B) remição - afetar",
      "C) remissão - auferir",
  ...
  }
  {
    ...
    banca: "FCC",
    difficulty: "Média",
    statement: "No trecho 'O contribuinte alegou desconhecimento da norma; IPCSO FACTO, a penalidade administrativa foi mantida pelo Fisco', a expressão destacada possui sentido equivalente a:",
    options: [
